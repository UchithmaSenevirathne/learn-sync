...
export const Register = () => {
    ...
    return (
        <div className="bg-[#E9EFF2] flex items-center justify-center font-anek h-screen">
            <div className="bg-white flex items-center justify-center flex-col w-[90%] py-32 rounded-xl">
                <h1 className="font-medium text-[45px] text-[#1D4DAF]">Sign Up</h1>
                <p className="font-medium text-[19px] text-gray-500 p-2">Hey enter your details to sign up your Account</p>
                ...
                <div className="flex gap-2 mt-10">
                    <p className="text-[19px] font-medium text-gray-500">Already have an account ?</p>
                    <a className="text-[#4B2FC8] text-[18px] font-semibold cursor-pointer" onClick={() => navigate("/login")}>SignIn now</a>
                </div>
            </div>
        </div>
    )
