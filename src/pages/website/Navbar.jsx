...
export const Navbar = () => {
    return (
        <div className="bg-[#FFFFFF] flex items-center justify-between font-anek text-lg h-[92px] px-50 shadow-md z-10 relative">
            <div className="flex items-center justify-center">
                <img src={navIcon} alt="StudentMale Logo" className="w-[34px] h-[35px]"/>
                <h1 className="font-bold text-[25px]">Learn Sync</h1>
            </div>
            <div>
                <ul className="flex items-center justify-center space-x-3 text-[18px] font-semibold">
                    <li>Home</li>
                    <li>About</li>
                    <li>Services</li>
                    <li>Contact</li>
