...
export const Chat = () => {
    return (
        <div className="flex flex-col font-anek p-5 gap-5">
            ...
            <div className="flex flex-col border border-gray-200 rounded-xl h-[690px]">
                <div className="flex-1"></div>
                <div className="flex justify-between items-center mx-20 my-5 border border-gray-200 rounded-xl gap-5 px-5 pt-4 relative">
                    <textarea
